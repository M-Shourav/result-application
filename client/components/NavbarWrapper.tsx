...
const Navbar: React.FC = () => {
  ...
  return (
    <div
      className={`py-5 max-w-screen-[1280px] mx-auto px-4 md:px-8 fixed top-0 left-0 w-full  z-50 bg-white/95 backdrop-blur transition-all duration-500 shadow-md ${
